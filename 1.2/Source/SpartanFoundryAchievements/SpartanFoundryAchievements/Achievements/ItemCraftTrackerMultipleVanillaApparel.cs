...
namespace AchievementsExpanded
{
    public class ItemCraftTrackerMultipleSpartanFoundry : Tracker<Thing>
    {
        ...
        public override MethodInfo PatchMethod => AccessTools.Method(typeof(SpartanFoundry_QuestManager_Notify_ThingsProduced_Patch),
            nameof(SpartanFoundry_QuestManager_Notify_ThingsProduced_Patch.CheckItemCraftedMultiple));
        ...
        public ItemCraftTrackerMultipleSpartanFoundry(ItemCraftTrackerMultipleSpartanFoundry reference) : base(reference)
        {
